...
//                        .requestMatchers("/my/**").hasAnyRole(RoleType.ADMIN.toString(), RoleType.USER.toString())
    ...
    @Bean
    AuthenticationManager profauthenticationManager(AuthenticationConfiguration auth) throws Exception {
        return auth.getAuthenticationManager();
    }

    @Bean
    public WebSecurityCustomizer profwebSecurityCustomizer() {
