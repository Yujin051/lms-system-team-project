...
//
//        // boardInfo
//        BoardInfo boardInfo1 = boardInfoRepository.save(new BoardInfo("게시판 이름1", "건의사항", true));
//        BoardInfo boardInfo2 = boardInfoRepository.save(new BoardInfo("게시판 이름2", "공지사항", true));
//        BoardInfo boardInfo3 = boardInfoRepository.save(new BoardInfo("게시판 이름3", "학생", true));
//        BoardInfo boardInfo4 = boardInfoRepository.save(new BoardInfo("게시판 이름4", "교원", true));
//        BoardInfo boardInfo5 = boardInfoRepository.save(new BoardInfo("게시판 이름5", "과정", true));
//        BoardInfo boardInfo6 = boardInfoRepository.save(new BoardInfo("게시판 이름6", "수업게시판", true));
//
//
//        // boardArticle
...
//
//        // gradeInfo
//        gradeInfoRepository.save(new GradeInfo(studLectApply1, "A", 95L, 95L, 89L));
//        gradeInfoRepository.save(new GradeInfo(studLectApply2, "B", 88L, 81L, 79L));
//        gradeInfoRepository.save(new GradeInfo(studLectApply2, "B", 81L, 77L, 98L));
//        gradeInfoRepository.save(new GradeInfo(studLectApply3, "B", 80L, 81L, 82L));
//        gradeInfoRepository.save(new GradeInfo(studLectApply5, "A", 91L, 95L, 90L));
//
//        // studLectProg
