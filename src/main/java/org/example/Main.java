...
//        Professor professor = professorRepository.save(new Professor(memberRepository.save(new Member("prof7", PasswordEncoder.encode("123123"), "호선생", "01012345679", "서울", "prof@prosf.com", LocalDate.of(2023, 1, 1), LocalDate.of(2023, 1, 1), Gender.MALE, RoleType.TEACHER)), "소속기관1", "00은행", "직무1", "111-222-333333", true))
//        LectInfo lectInfo = lectInfoRepository.save(new LectInfo(professor, "암호학개론", "필수과목", "2023", "2학기", 3L, 11L, 13L, LocalDate.of(2022, 1, 1), LocalDate.of(2022, 2, 3), LocalDate.of(2022, 3, 1), LocalDate.of(2022, 6, 3), true, 35L, 35L, 30L))
