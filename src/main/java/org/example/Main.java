...
import org.example.repository.admin.BoardArticleRepository;
import org.example.repository.admin.BoardInfoRepository;
...
public class Main implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // gradeInfo
        gradeInfoRepository.save(new GradeInfo(lectInfo1, student1, studLectApply1,"A", 95L, 95L, 89L, true));
        gradeInfoRepository.save(new GradeInfo(lectInfo2, student2, studLectApply2,"B", 88L, 81L, 79L, false));
        gradeInfoRepository.save(new GradeInfo(lectInfo3, student3, studLectApply2,"B", 81L, 77L, 98L, false));
        gradeInfoRepository.save(new GradeInfo(lectInfo4, student4, studLectApply3,"B", 80L, 81L, 82L, true));
        gradeInfoRepository.save(new GradeInfo(lectInfo5, student5, studLectApply5,"A", 91L, 95L, 90L, true));
