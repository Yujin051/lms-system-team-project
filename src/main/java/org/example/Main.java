...
import org.example.repository.admin.AdminGradeInfoRepository;
import org.example.repository.admin.AdminSemGradeRepository;
import org.example.repository.admin.AdminStudLectApplyRepository;
...
public class Main implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
     ...
     /*   memberRepository.save(new Member("admin", PasswordEncoder.encode("123123"), "관리자1", "010-2222-5555", "관리자네집", "admin@admin.com", LocalDate.of(2023, 1, 1), LocalDate.of(2023, 1, 1), Gender.MALE, RoleType.ADMIN, "", ""));
        ...
        Member member9 = memberRepository.save(new Member("student", PasswordEncoder.encode("123123"), "학생1", "010-6666-9999", "학생네집", "student@stud.com", LocalDate.of(2023, 1, 1), LocalDate.of(2023, 1, 1), Gender.MALE, RoleType.USER,"", ""));
        ...
        Member member8 = memberRepository.save(new Member("professor2", PasswordEncoder.encode("123123"), "선생2", "010-1132-8788", "서울", "professor2@stud.com", LocalDate.of(2023, 8, 1), LocalDate.of(2023, 8, 2), Gender.FEMALE, RoleType.TEACHER,"", ""));
        ...
        // boardArticle
        boardArticleRepository.save(new BoardArticle(boardInfo5, "게시글제목1", "게시글내용1", 10024L, LocalDate.of(2023, 1, 1), true, false, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo6, "게시글제목2", "게시글내용2", 5505L, LocalDate.of(2023, 2, 1), true, true, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo7, "게시글제목3", "게시글내용3", 111L, LocalDate.of(2023, 3, 1), false, false, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo8, "게시글제목4", "게시글내용4", 22L, LocalDate.of(2023, 4, 1), true, false, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo9, "게시글제목5", "게시글내용5", 1315L, LocalDate.of(2023, 5, 1), true, true, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo10, "게시글제목6", "게시글내용6", 513L, LocalDate.of(2023, 6, 1), true, false, member2));
        // 2번 게시판에 넣기
        boardArticleRepository.save(new BoardArticle(boardInfo2, "이의 있소 대체 뭘 어쩌자는건지...", "안녕하세요.",0L, LocalDate.now(), false, false, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo2, "이의 있소 대체 뭘 어쩌자는건지...", "안녕하세요.",0L, LocalDate.now(), false, false, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo2, "이의 있소 대체 뭘 어쩌자는건지...", "안녕하세요.",0L, LocalDate.now(), false, false, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo2, "이의 있소 대체 뭘 어쩌자는건지...", "안녕하세요.",0L, LocalDate.now(), false, false, member2));
        boardArticleRepository.save(new BoardArticle(boardInfo2, "이의 있소 대체 뭘 어쩌자는건지...", "안녕하세요.",0L, LocalDate.now(), false, false, member2));
        ...
        boardArticleRepository.save(new BoardArticle(boardInfo2, "이의 있소 대체 뭘 어쩌자는건지...", "안녕하세요.",0L, LocalDate.now(), false, false, member2));
        // 1번 게시판에 넣기
        boardArticleRepository.save(new BoardArticle(boardInfo1, "억울하면 어쩌겠나, 걷어찰 수 있는 거라곤 비싼 컴퓨터 밖에 없는 걸.", "안녕하세요.", 0L, LocalDate.now(), false, false, member3));
        boardArticleRepository.save(new BoardArticle(boardInfo1, "억울하면 어쩌겠나, 걷어찰 수 있는 거라곤 비싼 컴퓨터 밖에 없는 걸.", "안녕하세요.", 0L, LocalDate.now(), false, false, member3));
        boardArticleRepository.save(new BoardArticle(boardInfo1, "억울하면 어쩌겠나, 걷어찰 수 있는 거라곤 비싼 컴퓨터 밖에 없는 걸.", "안녕하세요.", 0L, LocalDate.now(), false, false, member3));
        boardArticleRepository.save(new BoardArticle(boardInfo1, "억울하면 어쩌겠나, 걷어찰 수 있는 거라곤 비싼 컴퓨터 밖에 없는 걸.", "안녕하세요.", 0L, LocalDate.now(), false, false, member3));
        boardArticleRepository.save(new BoardArticle(boardInfo1, "억울하면 어쩌겠나, 걷어찰 수 있는 거라곤 비싼 컴퓨터 밖에 없는 걸.", "안녕하세요.", 0L, LocalDate.now(), false, false, member3));
        ...
        boardArticleRepository.save(new BoardArticle(boardInfo1, "억울하면 어쩌겠나, 걷어찰 수 있는 거라곤 비싼 컴퓨터 밖에 없는 걸.", "안녕하세요.", 0L, LocalDate.now(), false, false, member3));
        // 3번 게시판에 넣기
        boardArticleRepository.save(new BoardArticle(boardInfo3, "최초 로그인 이후 반드시 비밀번호 재설정 바랍니다.", "관리자는 분명히 경고 했습니다...", 0L, LocalDate.now(), false, false, member1));
        boardArticleRepository.save(new BoardArticle(boardInfo3, "최초 로그인 이후 반드시 비밀번호 재설정 바랍니다.", "관리자는 분명히 경고 했습니다...", 0L, LocalDate.now(), false, false, member1));
        boardArticleRepository.save(new BoardArticle(boardInfo3, "최초 로그인 이후 반드시 비밀번호 재설정 바랍니다.", "관리자는 분명히 경고 했습니다...", 0L, LocalDate.now(), false, false, member1));
        boardArticleRepository.save(new BoardArticle(boardInfo3, "최초 로그인 이후 반드시 비밀번호 재설정 바랍니다.", "관리자는 분명히 경고 했습니다...", 0L, LocalDate.now(), false, false, member1));
        boardArticleRepository.save(new BoardArticle(boardInfo3, "최초 로그인 이후 반드시 비밀번호 재설정 바랍니다.", "관리자는 분명히 경고 했습니다...", 0L, LocalDate.now(), false, false, member1));
        ...
        boardArticleRepository.save(new BoardArticle(boardInfo3, "최초 로그인 이후 반드시 비밀번호 재설정 바랍니다.", "관리자는 분명히 경고 했습니다...", 0L, LocalDate.now(), false, false, member1));
        // 4번(교사) 게시판
        boardArticleRepository.save(new BoardArticle(boardInfo4, "교사 게시글 작성", "안녕하세요", 0L, LocalDate.now(), false, false, member8));
        boardArticleRepository.save(new BoardArticle(boardInfo4, "교사 게시글 작성", "안녕하세요", 0L, LocalDate.now(), false, false, member8));
        boardArticleRepository.save(new BoardArticle(boardInfo4, "교사 게시글 작성", "안녕하세요", 0L, LocalDate.now(), false, false, member8));
        boardArticleRepository.save(new BoardArticle(boardInfo4, "교사 게시글 작성", "안녕하세요", 0L, LocalDate.now(), false, false, member8));
        boardArticleRepository.save(new BoardArticle(boardInfo4, "교사 게시글 작성", "안녕하세요", 0L, LocalDate.now(), false, false, member8));
