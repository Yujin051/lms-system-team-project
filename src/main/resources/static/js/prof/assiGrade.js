...
detailBtn.forEach(function (element) {
    element.addEventListener('click', () => {
        ...
        document.querySelector('#lectId').value = lectId;
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response, function (index, EnteringGradeDto){
                    gradeId.append('<td>' + EnteringGradeDto.gradeId + '<td>' +
                        '<input type="hidden" name="gradeId" value=' + EnteringGradeDto.gradeId + '>');
                });
                ...
                checkScore.empty();
                $.each(response, function (index, EnteringGradeDto){
                    var inputElement = '<td style="display: block"><input type="text" name="checkScore" value="' + EnteringGradeDto.checkScore + '"></td>';
                ...
                assignScore.empty();
                $.each(response, function (index, EnteringGradeDto){
                    var inputElement = '<td style="display: block"><input type="text" name="assignScore" value="' + EnteringGradeDto.assignScore + '"></td>';
                ...
                testScore.empty();
                $.each(response, function (index, EnteringGradeDto){
                    var inputElement = '<td style="display: block"><input type="text" name="testScore" value="' + EnteringGradeDto.testScore + '"></td>';
